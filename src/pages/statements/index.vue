    ...
    <div class="content">
      ...
      <div class="searchbox">
        ...
        <el-select v-model="useStatuz" placeholder="请选择">
          <el-option v-for="item in useStatuzList" :key="item.value" :label="item.label" :value="item.value"></el-option>
        </el-select>
      ...
      <el-form :model="language">
       ...
       <el-form-item label="状态" label-width="90px">
        ...
        <el-form-item label="内容" label-width="90px">
          <el-input v-model="language.Contents" autocomplete="off" placeholder="内容" class="user_ipt" type="textarea" rows="3"></el-input>
        </el-form-item>
      </el-form>
...
<script>
import { statementsList,DelStatements,AddStatements,EditStatements } from "@/api/statements";
